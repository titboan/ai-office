...
# Склады WB, доступные для категорий «лакомства» и «корм» (зоотовары питание)
# Уточни список в ЛК WB → Логистика → Доступные склады для категории
config.WB_FOOD_CATEGORY_WAREHOUSES = [
    "Коледино", "Подольск", "Электросталь",   # МО
    "Краснодар",                                # Юг
    "Шушары",                                   # СПб
    "Казань",                                   # Поволжье
    "Екатеринбург",                             # Урал
...
config.WB_FOOD_CATEGORIES = ["лакомства", "корм"]   # категории для фильтрации складов WB
