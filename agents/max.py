...
- <b>текст</b> — заголовки разделов (Статистика, Отзывы, Итого)
- <code>артикул</code> — артикулы и ID товаров
- <blockquote>текст</blockquote> — краткий итог
- Эмодзи в начале разделов (🟣 🔵 📊 ⭐)
- НИКОГДА не используй Markdown: никаких *звёздочек*, |таблиц|, ##заголовков
