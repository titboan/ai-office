...
WB_CLUSTERS: dict[str, list[str]] = {
    "Центральный": ["Москва", "МО", "Истра", "Электросталь", "Подольск", "Внуково", "Коледино", "Тула", "Владимир", "Иваново", "Ярославль", "Рязань", "Калуга", "Брянск", "Орёл", "Смоленск", "Тверь", "Белгород", "Воронеж", "Липецк", "Курск", "Тамбов"],
    "Северо-Западный": ["СПб", "Санкт-Петербург", "Петербург", "Шушары", "Мурманск", "Архангельск", "Вологда", "Псков", "Новгород", "Петрозаводск", "Калининград"],
    "Южный и Северо-Кавказский": ["Краснодар", "Ростов", "Ставрополь", "Астрахань", "Волгоград", "Махачкала", "Владикавказ", "Нальчик"],
    "Приволжский": ["Казань", "Нижний", "Самара", "Уфа", "Пермь", "Саратов", "Ульяновск", "Оренбург", "Киров", "Чебоксары", "Ижевск", "Йошкар"],
    "Уральский": ["Екатеринбург", "Челябинск", "Тюмень", "Курган"],
    "Сибирский": ["Новосибирск", "Омск", "Красноярск", "Иркутск", "Кемерово", "Новокузнецк", "Барнаул", "Томск"],
    "Дальневосточный": ["Хабаровск", "Владивосток", "Артём", "Якутск", "Благовещенск"],
}
