...
- Длина ответа до 32 000 символов, можно делать подробные списки
...
class MartaAgent(BaseAgent):
    ...
    _CHAIN_PLANNER_SYSTEM = (
        ...
        "  dan    — дизайнер: генерация изображений, hero-картинки, иконки для лендингов и сайтов\n\n"
        "ПРАВИЛА ДЛЯ KASPER:\n"
        ...
        "  - лендинг/сайт по готовому референсу, макету или описанию — сразу kevin\n"
        ...
        "  - Дэн всегда идёт ДО Кевина — генерирует картинки, Кевин их использует в HTML\n"
        "  - НЕ включай Дэна для задач без визуального контента (боты, скрипты, API)\n"
        "  - Дэн получает от Каспера/Питера контекст о нише и передаёт Кевину пути к файлам\n\n"
        "ТИПОВЫЕ ЦЕПОЧКИ:\n"
        "  Лендинг/сайт по готовому референсу или макету: [kevin]\n"
        "  Лендинг/сайт с изображениями по референсу или с нуля: [dan, kevin]\n"
        "  Лендинг с исследованием + изображения: [kasper, dan, kevin]\n"
        "  Лендинг/сайт с исследованием рынка перед разработкой: [kasper, kevin]\n"
        "  Технический проект (бот, приложение): [kevin] или [kasper, kevin] или [kasper, peter, kevin]\n"
        "  Контентный проект: [kasper, elina] или [elina]\n"
        "  Бизнес-исследование: [kasper, peter] или [kasper, peter, elina]\n"
        "  Полный проект (исследование + анализ + дизайн + разработка): [kasper, peter, dan, kevin]\n"
    ...
    def _help_text(self) -> str:
        return (
            ...
            "*«создай лендинг», «напиши бота», «задеплой на Pages»*\n\n"
            "📊 **Питер** — аналитика маркетплейсов WB+Ozon\n"
            "*«отчёт по продажам», «воронка конверсии», «ДРР»*\n\n"
            "✍️ **Элина** — тексты и контент\n"
            "*«напиши описание товара», «создай пост»*\n\n"
            "🗓️ **Алекс** — планирование и напоминания\n"
            "*«напомни в 18:00», «составь roadmap»*\n\n"
            "🎨 **Дэн** — генерация изображений\n"
            "*«нарисуй hero для лендинга», «иконки для секции»*\n\n"
            "🛒 **Макс** — маркетплейсы WB+Ozon (синхронизация данных)\n"
            "*«синхронизируй остатки», «обработай отзывы»*\n\n"
