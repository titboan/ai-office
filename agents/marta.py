...
class MartaAgent(BaseAgent):
    ...
    _CHAIN_PLANNER_SYSTEM = (
        ...
        "peter (бизнес-аналитик, ставь ПОСЛЕ каспера когда нужен анализ рынка, "
        "конкурентов, рисков, бизнес-выводы — для проектных и исследовательских задач), "
        "elina (тексты/контент), alex (планирование/задачи).\n"
        "Питера включай для запросов: создать продукт/сервис/бот, исследовать рынок, "
        "запустить проект, проанализировать нишу.\n"
