...
async def _create_schema() -> None:
    ...
    async with pool.acquire() as conn:
        ...
        """)
        logger.info("[db] Схема готова ✓ (tasks + marketplace + funnel + snapshots + promotions + kpi + questions + keywords + returns + fin_adv + product_prices + wb_nm_id + product_cards)")
