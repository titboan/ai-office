...
Фоновые задачи:
  ...
  ├── Ева — email-дайджест: 09:30 МСК (нужен EVA_BOT_TOKEN + EMAIL_APP_PASS)
...
- [ ] **Деплой Евы (email-дайджест)** — добавить `EVA_BOT_TOKEN`, `EMAIL_USER`, `EMAIL_APP_PASS` → `/email_digest 1d` работает без Telethon
