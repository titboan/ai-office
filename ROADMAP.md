...
> Обновление 2026-07-03: Фаза 1 (прокси-команды всех агентов на Марте) реализована и сверена с кодом — см. `plans/2026-06-24-single-entry-marta.md`. Фазы 2-4 (callback-кнопки, wizards, отключение отдельных ботов) — ещё нет.
